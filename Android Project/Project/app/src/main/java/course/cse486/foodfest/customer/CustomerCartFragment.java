...
import course.cse486.foodfest.utils.fcm.APIService;
import course.cse486.foodfest.utils.fcm.Client;
import course.cse486.foodfest.utils.fcm.Data;
import course.cse486.foodfest.utils.fcm.MyResponse;
import course.cse486.foodfest.utils.fcm.NotificationSender;
...
import course.cse486.foodfest.utils.adapters.customer.CustomerCartAdapter;
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        CustomAlert.ShowAlert(getContext(), "", "Your Order has been shifted to Pending state, please wait until the Chef accept your order.");
                                                                                                                                    }
...
//                                                                }
                                                ...
                                                CustomAlert.ShowAlert(getContext(), "Error", "It seems you have already placed the order, So you cannot place another order until the delivery of first order");
                                            }
