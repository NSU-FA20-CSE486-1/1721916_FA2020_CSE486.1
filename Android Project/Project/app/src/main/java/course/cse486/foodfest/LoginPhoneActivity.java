    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b=new Intent(LoginPhoneActivity.this, SendOTPActivity.class);
        ...
        txtsignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a=new Intent(LoginPhoneActivity.this, RegistrationActivity.class);
                startActivity(a);
                finish();
            }
        });
        ...
        signinemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent em=new Intent(LoginPhoneActivity.this, LoginActivity.class);
                startActivity(em);
                finish();
            }
        });
