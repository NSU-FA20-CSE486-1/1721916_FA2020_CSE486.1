    ...
    protected void onCreate(Bundle savedInstanceState) {
                                                            ...
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        Intent b = new Intent(RegistrationActivity.this, VerifyPhoneActivity.class);
                                                                ...
                                                                mDialog.dismiss();
                                                                CustomAlert.ShowAlert(RegistrationActivity.this,"Error",task.getException().getMessage());
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(RegistrationActivity.this, LoginPhoneActivity.class);
                startActivity(e);
                finish();
            }
        });
