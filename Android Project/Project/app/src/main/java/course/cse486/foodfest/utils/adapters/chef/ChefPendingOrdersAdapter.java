package course.cse486.foodfest.utils.adapters.chef;
...
import course.cse486.foodfest.chef.ChefOrderedDishes;
...
import course.cse486.foodfest.models.ChefPendingOrders1;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Vieworder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ChefOrderedDishes.class);
                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        CustomAlert.ShowAlert(context,"","Wait for the Customer to make Payment");
