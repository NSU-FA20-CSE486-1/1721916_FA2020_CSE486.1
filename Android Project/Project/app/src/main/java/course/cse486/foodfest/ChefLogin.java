        ...
        try {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        Intent z = new Intent(ChefLogin.this, ChefFoodPanelActivity.class);
                                        startActivity(z);
                                        finish();


                                    } else {
                                        CustomAlert.ShowAlert(ChefLogin.this, "", "Please Verify your Email");
                                    }

                                } else {

                                    mDialog.dismiss();
                                    CustomAlert.ShowAlert(ChefLogin.this, "Error", task.getException().getMessage());
                                }
                            }
                        });
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(ChefLogin.this, ChefRegistrationActivity.class);
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent q = new Intent(ChefLogin.this, ChefPhoneLoginActivity.class);
                    startActivity(q);
                    finish();
                }
            });
