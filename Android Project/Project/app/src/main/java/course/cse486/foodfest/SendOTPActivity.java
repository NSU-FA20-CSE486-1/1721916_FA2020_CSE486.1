                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Intent intent = new Intent(SendOTPActivity.this, CustomerFoodPanelActivity.class);
                                startActivity(intent);
                                finish();
                            } else {
                                CustomAlert.ShowAlert(SendOTPActivity.this,"Error",task.getException().getMessage());
                            }
                        }
                    });
        } catch (Exception e) {
