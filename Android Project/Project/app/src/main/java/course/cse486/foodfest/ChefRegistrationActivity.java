    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(ChefRegistrationActivity.this);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Chef")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(ChefRegistrationActivity.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(ChefRegistrationActivity.this, ChefVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            CustomAlert.ShowAlert(ChefRegistrationActivity.this, "Error", task.getException().getMessage());
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ChefRegistrationActivity.this, ChefLogin.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(ChefRegistrationActivity.this, ChefPhoneLoginActivity.class);
                startActivity(e);
                finish();
            }
        });
