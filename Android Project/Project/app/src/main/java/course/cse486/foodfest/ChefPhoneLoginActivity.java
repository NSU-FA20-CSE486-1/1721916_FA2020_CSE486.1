...
public class ChefPhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSend =(Button)findViewById(R.id.otp);
        ...
        txtsignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a=new Intent(ChefPhoneLoginActivity.this, ChefRegistrationActivity.class);
                startActivity(a);
                finish();
            }
        });
        ...
        mEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent em=new Intent(ChefPhoneLoginActivity.this, ChefLogin.class);
                startActivity(em);
                finish();
            }
        });
