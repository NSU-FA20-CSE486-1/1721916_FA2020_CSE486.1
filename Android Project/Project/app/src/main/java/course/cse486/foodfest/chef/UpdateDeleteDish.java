...
import course.cse486.foodfest.models.Chef;
import course.cse486.foodfest.ChefFoodPanelActivity;
import course.cse486.foodfest.models.FoodSupplyDetails;
import course.cse486.foodfest.models.UpdateDishModel;
...
public class UpdateDeleteDish extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateDeleteDish.this);
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                AlertDialog.Builder food = new AlertDialog.Builder(UpdateDeleteDish.this);
                                food.setMessage("Your Dish has been Deleted");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {

                                        startActivity(new Intent(UpdateDeleteDish.this, ChefFoodPanelActivity.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(UpdateDeleteDish.this);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Glide.with(UpdateDeleteDish.this).load(updateDishModel.getImageURL()).into(imageButton);
        ...
        if (imageuri != null) {
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(UpdateDeleteDish.this, "Failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID)
                .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(UpdateDeleteDish.this, "Dish Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    }
