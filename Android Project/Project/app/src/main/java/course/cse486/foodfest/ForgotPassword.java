                ...
                FAuth.sendPasswordResetEmail(forgetpassword.getEditText().getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            mDialog.dismiss();
                            CustomAlert.ShowAlert(ForgotPassword.this,"","Password has been sent to your Email");
                        } else {
                            mDialog.dismiss();
                            CustomAlert.ShowAlert(ForgotPassword.this,"Error",task.getException().getMessage());
                        }
                    }
                });
            }
